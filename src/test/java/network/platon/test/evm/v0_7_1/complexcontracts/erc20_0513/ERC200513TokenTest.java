package network.platon.test.evm.v0_7_6.complexcontracts.erc20_0513;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.contracts.evm.v0_7_6.ERC200513Token;
...
public class ERC200513TokenTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "hudenian", showName = "ERC200513TokenTest-测试0.5.13版本ERC20", sourcePrefix = "evm/0.7.6")
    public void erc20Test() {
        try {

            ERC200513Token eRC200513Token = ERC200513Token.deploy(web3j, transactionManager, provider, new BigInteger(initialSupply), tokenName, tokenSymbol).send();
