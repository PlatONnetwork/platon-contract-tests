...
import network.platon.contracts.evm.v0_7_6.Guessing;
...
public class GuessingTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "hudenian", showName = "function.GuessingTest-竞猜合约测试", sourcePrefix = "evm/0.7.6")
    public void guessingTest() {
        ...
        try {
            ...
            TransactionReceipt transactionReceipt = transfer.sendFunds(contractAddress, new BigDecimal("1000"), Convert.Unit.KPVON, new BigInteger("1000000000"), new BigInteger("4712388")).send();
