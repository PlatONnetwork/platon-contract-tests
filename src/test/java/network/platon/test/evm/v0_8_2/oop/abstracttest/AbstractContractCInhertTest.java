...
import network.platon.contracts.evm.v0_7_6.AbstractContractFSubclass;
...
public class AbstractContractCInhertTest extends ContractPrepareTest {
   ...
   private String name,resultName;
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "AbstractContract.抽象合约继承抽象合约执行情况",sourcePrefix = "evm/0.7.6")
