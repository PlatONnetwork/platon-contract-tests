...
public class AddressFunctionsTest extends ContractPrepareTest {
    ...
    public void Addressfunctions() {
        try {
            ...
            balanceaddr = Bech32.addressEncode(NetworkParameters.getHrp(),balanceaddr);
            ...
            transferaddr = Bech32.addressEncode(NetworkParameters.getHrp(),transferaddr);
            ...
            sendsddr = Bech32.addressEncode(NetworkParameters.getHrp(),sendsddr);
