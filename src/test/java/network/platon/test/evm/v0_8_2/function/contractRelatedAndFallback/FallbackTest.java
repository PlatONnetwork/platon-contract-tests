package network.platon.test.evm.v0_8_2.function.contractRelatedAndFallback;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.autotest.junit.annotations.DataSource;
import network.platon.autotest.junit.enums.DataSourceType;
import network.platon.contracts.evm.v0_7_6.FallBack;
...
public class FallbackTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "liweic", showName = "function.FallbackTest-this和回退函数测试", sourcePrefix = "evm/0.7.6")
