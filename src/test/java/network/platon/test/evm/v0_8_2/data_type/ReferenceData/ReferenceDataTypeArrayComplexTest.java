...
import network.platon.contracts.evm.v0_7_6.ReferenceDataTypeArrayComplexContract;
...
public class ReferenceDataTypeArrayComplexTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "ReferenceDataTypeArrayComplex.含数组（Array）运算逻辑合约",sourcePrefix = "evm/0.7.6")
