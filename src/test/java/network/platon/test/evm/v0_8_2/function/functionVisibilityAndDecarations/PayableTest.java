package network.platon.test.evm.v0_8_2.function.functionVisibilityAndDecarations;
...
import network.platon.contracts.evm.v0_7_6.Payable;
...
public class PayableTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "liweic", showName = "function.PayableTest-函数声明方式Payable测试", sourcePrefix = "evm/0.7.6")
    public void payable() {
        try {
            ...
            toAdddress = Bech32.addressEncode(NetworkParameters.getHrp(), toAdddress);
