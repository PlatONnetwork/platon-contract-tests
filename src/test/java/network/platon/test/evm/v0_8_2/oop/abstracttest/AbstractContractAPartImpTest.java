...
import network.platon.contracts.evm.v0_7_6.AbstractContractFather;
...
public class AbstractContractAPartImpTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "AbstractContract.抽象合约实现部分执行情况",sourcePrefix = "evm/0.7.6")
