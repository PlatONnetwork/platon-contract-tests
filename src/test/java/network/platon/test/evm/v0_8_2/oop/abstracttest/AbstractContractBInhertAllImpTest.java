package network.platon.test.evm.v0_8_2.oop.abstracttest;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.autotest.junit.annotations.DataSource;
import network.platon.autotest.junit.enums.DataSourceType;
import network.platon.contracts.evm.v0_7_6.AbstractContractBSubclass;
...
public class AbstractContractBInhertAllImpTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "AbstractContract.抽象合约单继承且实现执行情况",sourcePrefix = "evm/0.7.6")
