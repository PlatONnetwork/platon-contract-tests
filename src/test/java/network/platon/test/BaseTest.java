...
//
//        TransactionReceipt transactionReceipt = new Transfer(web3j,new RawTransactionManager(web3j, credentials)).sendFunds(transferTo, new BigDecimal(1), Convert.Unit.LAT).send();
