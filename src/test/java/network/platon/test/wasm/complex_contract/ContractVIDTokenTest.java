...
public class ContractVIDTokenTest extends WASMContractPrepareTest {
    ...
    public void testHomeBridge() {
        try {
            ...
            t.sendFunds(contractAddress, new BigDecimal(1000), Convert.Unit.KPVON, provider.getGasPrice(), provider.getGasLimit()).send();
            ...
            Uint128 afterIncreaseAllowance = contract.Allowance(credentials.getAddress(), to).send();
            ...
            Uint128 afterDecreaseAllowance = contract.Allowance(credentials.getAddress(), to).send();
...
//            Credentials spendCredentials = Credentials.create("a11859ce23effc663a9460e332ca09bd812acc390497f8dc7542b6938e13f8d7");
            ...
            t.sendFunds(spendCredentials.getAddress(), new BigDecimal(100000), Convert.Unit.KPVON, provider.getGasPrice(), provider.getGasLimit()).send();
            BigInteger spendBalance = web3j.platonGetBalance(spendCredentials.getAddress(), DefaultBlockParameterName.LATEST).send().getBalance();
