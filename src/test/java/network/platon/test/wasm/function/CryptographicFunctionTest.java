...
public class CryptographicFunctionTest extends WASMContractPrepareTest {
    ...
    public void cryptographicTest() {
        ...
        try {
            prepare();
            CryptographicFunction cryptographicFunction = CryptographicFunction.deploy(web3j, transactionManager, provider).send();
            ...
            String bech32Address = Bech32.addressEncode(NetworkParameters.getHrp(), publicKey);
