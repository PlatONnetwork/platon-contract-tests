...
//
//                        SolSimulation solSimulation = SolSimulation.deploy(web3j, transactionManager, provider, Uint32.of(32), Uint32.of(0)).send();
...
//
//                        TransactionReceipt transactionReceiptAction = SolSimulation.load(contractAddress, web3j, transactionManager, provider).action().send();
//
//                        TransactionReceipt transactionReceipt = SolSimulation.load(contractAddress, web3j, transactionManager, provider).debug().send();
//
