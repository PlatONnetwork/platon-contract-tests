...
public class CreateContractTest extends WASMContractPrepareTest {
    ...
    public void testCloneAndCreate() {
        try {
            // deploy contract.
            SimpleContract simpleContract = SimpleContract.deploy(web3j, transactionManager, provider).send();
            ...
            SimpleContract deploySimpleContract = SimpleContract.load(deploySimple.toString(), web3j, transactionManager, provider);
            ...
            SimpleContract cloneSimpleContract = SimpleContract.load(cloneSimple.toString(), web3j, transactionManager, provider);
            ...
            // migrate test
            CreateContract migrateCreateContract = CreateContract.deploy(web3j, transactionManager, provider).send();
            ...
            SimpleContract migrateSimpleContract = SimpleContract.load(migrateSimpleAddress.toString(), web3j, transactionManager, provider);
            ...
            // migrate clone test
            CreateContract migrateCloneCreateContract = CreateContract.deploy(web3j, transactionManager, provider).send();
            ...
            SimpleContract migrateCloneSimpleContract = SimpleContract.load(migrateCloneSimpleAddress.toString(), web3j, transactionManager, provider);
            ...
            CreateContract failMigrateCreateContract = CreateContract.deploy(web3j, transactionManager, provider).send();
            ...
            for(int i = 0; i < 20; i++){
                ...
                failMigrateDeployContract = CreateContract.load(failMigrateDeployAddress.toString(), web3j, transactionManager, provider);
