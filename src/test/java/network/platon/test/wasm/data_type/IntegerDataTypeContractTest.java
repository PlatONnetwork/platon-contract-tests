...
public class IntegerDataTypeContractTest extends WASMContractPrepareTest {
    ...
    public void testBaseTypeContract_04() {
        ...
        try {
            ...
            collector.assertEqual(afterInitAddress.toLowerCase(), "lat1w2kjkufl4g2v93xd94a0lewc75ufdr66vksnq9".toLowerCase());

//            // test: store address
            String expectAddr = "lat1fyeszufxwxk62p46djncj86rd553skppy4qgz4";
