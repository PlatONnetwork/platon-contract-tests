...
public class ContractCypherBankTest extends WASMContractPrepareTest {
    ...
    public void testSimpleStorageContract() {
        try {
            ...
            t.sendFunds(contractAddress, new BigDecimal("1"), Convert.Unit.KPVON, provider.getGasPrice(), provider.getGasLimit()).send();
            ...
            // buy
            WasmAddress receiver = new WasmAddress("lat1uqug0zq7rcxddndleq4ux2ft3tv6dqljwjkzds");
            ...
            // transfer
            TransactionReceipt transferTr = contract.transfer(new WasmAddress("lat1w2kjkufl4g2v93xd94a0lewc75ufdr66vksnq9"), new Xuint128("300000000000000000")).send();
            ...
            // balanceOf
            Uint128 balanceOf = contract.balanceOf(new WasmAddress("lat1w2kjkufl4g2v93xd94a0lewc75ufdr66vksnq9")).send();
...
//            BigInteger dividendsOf = contract.dividendsOf(new WasmAddress(credentials.getAddress())).send();
            Uint128 dividendsOf = contract.dividendsOf(new WasmAddress("lat1w2kjkufl4g2v93xd94a0lewc75ufdr66vksnq9")).send();
